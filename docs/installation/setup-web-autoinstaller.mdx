...
## Installation
SSH into your VPS/Dedicated Server and run the following command:

```
curl -s "https://minetrax.github.io/install.sh" | bash
```

It will start the installation process and will take some time to complete.
1. During the installation process, you will be asked to confirm installation by pressing `y` and enter a few time.
2. You will also get prompted to enter a database name and password for minetrax installation, Enter your desired data there and press enter.
3. In final step you will be asked to enter Domain name which will open up minetrax. Enter your domain name there and press enter.
...
2. [Add your First Minecraft Server to Web](../web/adding-minecraft-server)
